...
const WritePost = ({ post, categories }: { post: Post, categories: Array<Category> | undefined}) => {
  ...
  return (
    <div className={styles.writePost}>
      ...
      ><SideMenu summaryProp={post?.summary || ''} tags={post?.tags as string[]} postId={String(post.id)} activeCategories={activeCategories} setActiveCategories={setActiveCategories} categories={categories} imageUrl={post.backgroundImage}/></Drawer>
